...
function cpt_actu() {
	...
	$labels = array(
		'name'                => _x( 'Les articles d\'actu', 'Post Type General Name', 'text_domain' ),
		'singular_name'       => _x( 'Articles actu', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'           => __( 'Actu', 'text_domain' ),
		'parent_item_colon'   => __( 'Parent Actu :', 'text_domain' ),
	...
	$args = array(
		'label'               => __( 'Actu', 'text_domain' ),
		'description'         => __( 'Actu information', 'text_domain' ),
		'labels'              => $labels,
